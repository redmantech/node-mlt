...
Properties.prototype.attribs = function (att, val) {
  return this._setPropsOrAttribs(att, val, true)
}

Properties.prototype.props = function (prop, val) {
  return this._setPropsOrAttribs(prop, val, false)
}

Properties.prototype._setPropsOrAttribs = function (name, val, is_att) {
...
Properties.prototype._clearPropOrAttrib = function(name, val, is_att) {
  if (val === '' || val === null) {
    if (is_att) {
